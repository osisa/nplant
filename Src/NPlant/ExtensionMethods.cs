...
public static class ExtensionMethods
{
    ...
    public static T CheckForNull<T>(this T obj, Func<Exception> exceptionProvider = null)
        where T : class
    {
        if (exceptionProvider == null)
            exceptionProvider = () => new NullReferenceException(string.Format("The supplied {0} instance was null when null was not expected.", typeof(T).FullName));
    ...
    public static T CheckForNullArg<T>(this T obj, string argumentName)
        where T : class
    {
    ...
    public static T GetAttributeOf<T>(this Type type, bool inherit = false)
        where T : Attribute
    {
    ...
    public static T[] GetAttributesOf<T>(this Type type, bool inherit = false)
        where T : Attribute
    {
        var customAttributes = type.GetCustomAttributes(typeof(T), inherit);
    ...
    public static T[] GetAttributesOf<T>(this PropertyInfo property, bool inherit = false)
        where T : Attribute
    {
    ...
    public static T[] GetAttributesOf<T>(this FieldInfo field, bool inherit = false)
        where T : Attribute
    {
    ...
    public static bool HasAttribute<T>(this PropertyInfo property, bool inherit = false)
        where T : Attribute
    {
    ...
    {
        return type.Assembly == _mscorelib;
    }
